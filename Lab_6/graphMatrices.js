...
const createDirectMatrix = (strVariant, isB = false) => {
    ...
    for (let i = 0; i < count; i++) {
        for (let j = 0; j < count; j++) {
            dirMatrix[i][j] = isB?  generator()  : Math.floor(generator() * 2 * k);
        }
    }
...
export {dirMatrix, unDirMatrix, createDirectMatrix}
